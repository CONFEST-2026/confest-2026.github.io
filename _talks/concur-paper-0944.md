...
links:
  - name: DOI
    absolute_url: https://doi.org/10.4230/LIPIcs.CONCUR.2026.27
---
...
which the corresponding minimal NFA can be built in
$O(m \log n)$ time (where $m$ is the number of edges and $n$
...
*canonical* Wheeler NFA and (ii) the resulting Wheeler
